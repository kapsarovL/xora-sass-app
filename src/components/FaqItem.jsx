    ...
    <div className="relative mb-16 z-2">
        ...
        >
            <div className="flex-1">
                <div className="small-compact mb-1.5 text-p3 mx-lg:hidden">
                    {index < 10 ? "0" : ""}
                    {index}
                </div>
                <div className={clsx(
            ...
            <div 
            className={clsx(
                "faq-icon relative size-12 flex justify-center rounded-full border-2 border-s2 shadow-400 transition-all duration-500 group-hover:border-s4",
